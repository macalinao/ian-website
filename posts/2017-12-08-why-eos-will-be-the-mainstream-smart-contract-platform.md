---
title: Why EOS will be the mainstream smart contract platform
---
...
Furthermore, the Ethereum block time is around 30s, which will be reduced to around 5-7 seconds when PoS is introduced. **You may have a lag of up to 30 seconds after every action.** This prohibits many types of applications that require more real-time feedback, e.g. decentralized asset exchange.
...
EOS is real estate because it works in a completely different way from Bitcoin or Ethereum: token holders get a percentage of the bandwidth of the EOS network relative to their total share of the tokens. If EOS can handle 100k transactions/second and you hold 1% of tokens, you are reserved 1k tx/sec. The only cost to developing your dapp is purchasing tokens in the first place. Furthermore, if you are not a dapp developer, you can rent your stake in the network, allowing you to collect interest on your stake.
